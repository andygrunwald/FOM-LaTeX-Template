...
\usepackage{mdwlist}
\usepackage{tabularx}% für breitenangabe%muss weiter unten eingesetzt werden
...
%-----------------------------------
% Damit die hochgestellten Zahlen auch auf die Fußnote verlinkt sind
%-----------------------------------
% hyperef soll als aller letztes Paket geladen werden und danach erst tabularx sonst werden Fußnoten auf die erste Seite verlinkt
%Quelle: https://golatex.de/viewtopic.php?t=6356
% geändert am 17.05.2020
%-----------------------------------
%\usepackage{hyperref}%vorher Zeile 51
