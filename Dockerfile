...
RUN echo 'deb http://ppa.launchpad.net/jonathonf/texlive/ubuntu xenial main' > /etc/apt/sources.list.d/texlive.list \
	&& echo 'deb-src http://ppa.launchpad.net/jonathonf/texlive/ubuntu xenial main' >> /etc/apt/sources.list.d/texlive.list \
