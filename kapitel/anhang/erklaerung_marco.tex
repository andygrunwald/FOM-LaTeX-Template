...
%-----------------------------------
\section*{%
	\langde{Ehrenwörtliche Erklärung Marco Kothke}
	\langen{Declaration in lieu of oath Marco Kothke}}
...
\begin{table}[H]
	...
	\begin{tabular*}{\textwidth}{c @{\extracolsep{\fill}} ccccc}
		...
		\includegraphics[width=0.35\textwidth]{unterschrift_marco}\vspace*{-0.35cm}
		\\
