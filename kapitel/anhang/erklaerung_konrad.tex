...
%-----------------------------------
\section*{%
	\langde{Ehrenwörtliche Erklärung Konrad Hölzenbein}
	\langen{Declaration in lieu of oath Konrad Hölzenbein}}
...
\begin{table}[H]
	...
	\begin{tabular*}{\textwidth}{c @{\extracolsep{\fill}} ccccc}
		...
		\includegraphics[width=0.35\textwidth]{unterschrift_konrad}\vspace*{-0.35cm}
		\\
