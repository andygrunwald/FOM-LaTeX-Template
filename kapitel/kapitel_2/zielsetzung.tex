...
Ziel der Arbeit ist es, die Effektivität eines \ac{soar}-Systems zu untersuchen, indem Techniken der MITRE \ac{attck} simuliert und deren Automatisierungspotenzial analysiert werden. Dazu sollen Logs überprüft, \ac{IOC} festgelegt und Entscheidungsprozesse automatisiert werden. Abschließend werden Vor- und Nachteile der SOAR-Lösung sowie der Automatisierungsgrad in Prozent dargestellt.
\begin{comment}
